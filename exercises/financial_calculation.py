...
print("Scenario 1 future value:", round(future_value_1, 2))
print("Scenario 2 future value:", round(future_value_2, 2))

# Comparison
diff = round(future_value_1 - future_value_2, 2)
print("Scenario 1 earns", diff, "more than Scenario 2")
